...
:  The {{site.data.keyword.wca_short}} extension for Visual Studio Code, version 1.7.0, now supports Japanese as a display language. For more information, see [How to change the display language](/docs/watsonx-code-assistant?topic=watsonx-code-assistant-cloud-setup-wca-vscode#cloud-setup-wca-vscode-display-language).
