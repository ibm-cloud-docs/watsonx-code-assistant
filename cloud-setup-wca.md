...
1. Use the catalog to provision a service instance of {{site.data.keyword.wca_short}}. The service is available in the Dallas (`us-south`) and Frankfurt (`eu-de`) data centers.
