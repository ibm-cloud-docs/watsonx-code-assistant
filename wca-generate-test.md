...
| --- | --- | --- |
| [Trial plan]{: tag-magenta} [Essentials plan]{: tag-green} | Basic | Uses generative AI to provide a generic unit test.|
| [Standard plan]{: tag-purple} | Enhanced | Uses generative AI to provide a Java specific unit test.|
